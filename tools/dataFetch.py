...
class Spider_baidu_image():
    def __init__(self,keyword,paginator,dir="datasets/org"):
    ...
    def get_image(self, image_url):
        ...
        """
        cwd = os.getcwd()
        file_name = os.path.join(cwd,"datasets","org",self.keyword)
        if not os.path.exists(file_name):
            os.mkdir(file_name)
        for index, url in enumerate(image_url, start=1):
            with open(file_name + '\\{}.jpg'.format(random.randint(0,10000000)), 'wb') as f:
...
if __name__ == '__main__':
    # spider = Spider_baidu_image("浮标",10)
    # spider()
    # spider = Spider_baidu_image("灯塔", 10)
    # spider()
    # spider = Spider_baidu_image("帆船", 10)
    # spider()
    # spider = Spider_baidu_image("轨条", 10)
    # spider()
    # spider = Spider_baidu_image("货船", 10)
    # spider()
    # spider = Spider_baidu_image("海军舰艇", 10)
    # spider()
    spider = Spider_baidu_image("客轮", 10)
    spider()
    # spider = Spider_baidu_image("码头", 10)
    # spider()
    # spider = Spider_baidu_image("潜艇", 10)
    # spider()
    # spider = Spider_baidu_image("渔船", 10)
    # spider()
